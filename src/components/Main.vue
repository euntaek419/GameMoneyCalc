...
<!-- ------------------------------------------------------------------------------------------------------ -->
          ...
          <div>
            <input class="price_input" maxlength='11' v-model="Money" :style="{ color : fontchange[0] }" @input="updateMoney">
            <div class="UnderBar">
      ...
      <label>
        <span class="CashSell">
          ...
          <div>
            <input class="price_input right" maxlength="10" v-model="Cash" :style="{ color : fontchange[1] }" @input="updateCash">
            <div class="UnderBar">
                <img src="../assets/images/UnderBar.gif">
            </div>
            <div>
    ...
    <div class="SetBox">
      <div class="option_title_box">
        <div class="option_title">
          현금 거래 비율
          <span class="Exchange_img_box">
      ...
      <div class="CashRatioInputBox">
        <span>
          ...
          <img src="../assets/images/UnderBar.gif" class="CashRatioInput_Under" v-show=" Ratio == ''">
        </span>
